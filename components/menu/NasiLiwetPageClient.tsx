...
export default function NasiLiwetPageClient({ items }: { items: MenuItem[] }) {
  ...
  const filteredLiwet = useMemo(() => {
    ...
    return items.filter((item) => {
      if (selectedCategory === "semua") {
        return LIWET_ITEM_CATEGORIES.includes(item.category);
      }
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          <div className="bg-[#faf0f4] rounded-[20px] p-6 space-y-2 shadow-[0_2px_12px_rgba(168,40,104,0.04)]">
            ...
            <ul className="text-xs text-[#665b56] space-y-1.5 list-disc list-inside">
              <li>
                Beli air mineral 330 ml: <strong className="text-[#241b18]">+ Rp 4.000</strong>
              </li>
              <li>
                Ganti nasi putih: <strong className="text-[#241b18]">- Rp 5.000</strong>
              </li>
              <li>
                Beli kol goreng: <strong className="text-[#241b18]">+ Rp 3.000</strong>
              </li>
              <li>
                Beli ikan asin: <strong className="text-[#241b18]">+ Rp 8.000</strong>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#faf0f4] rounded-[20px] p-6 space-y-2 shadow-[0_2px_12px_rgba(168,40,104,0.04)]">
            ...
            <p className="text-xs text-[#665b56] leading-relaxed">
              Isi Paket Umum Tampah: Nasi liwet, Udang goreng, Ikan asin, Ayam
              goreng/bakar, Urap, Sambal & lalapan.
            </p>
        ...
        <div className="bg-[#ffffff] rounded-[24px] p-8 sm:p-10 text-center max-w-2xl mx-auto shadow-[0_8px_30px_rgba(168,40,104,0.06)] space-y-3">
          ...
          <p className="text-[#665b56] text-xs sm:text-sm leading-relaxed max-w-lg mx-auto">
            Bisa dong.. kamu bisa mix lauknya sesuai dengan yang kamu mau untuk
            paket nasi liwet kotak atau tampah. Langsung chat mimin untuk info
            lebih lanjut ya.
          </p>
          <div className="pt-2">
            <Button
