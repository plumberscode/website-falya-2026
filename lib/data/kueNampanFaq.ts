...
export const KUE_NAMPAN_FAQ: KueNampanFaqItem[] = [
  {
    ...
    answer:
      "Minimal order kue nampan Falya adalah 1 nampan. Untuk acara besar seperti arisan atau tahlilan, kamu bisa pesan beberapa nampan sekaligus — tinggal sesuaikan jumlah tamu.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Disarankan pesan minimal H-1 sebelum acara agar kue tetap fresh dan persiapan bisa maksimal, terutama untuk pesanan dalam jumlah banyak seperti arisan atau tahlilan.",
  },
];
